...
#define LIMINE_ATTRIBUTE_REQUEST __attribute__((used, section(".limine_requests")))
#define LIMINE_ATTRIBUTE_REQUESTS_START __attribute__((used, section(".limine_requests_start")))
#define LIMINE_ATTRIBUTE_REQUESTS_END __attribute__((used, section(".limine_requests_end")))
